                        ...
                        <div className="bg-white/[0.03] rounded-[2rem] p-6 border border-white/5 shadow-inner">
                            <Calendar
                                ...
                                classNames={{
                                    ...
                                    head_cell: "text-primary/40 w-9 font-black text-[10px] uppercase tracking-widest text-center flex-1",
                                    row: "flex w-full mt-1 justify-between",
                                    cell: "relative p-0 text-center text-sm flex-1 h-9 flex items-center justify-center",
