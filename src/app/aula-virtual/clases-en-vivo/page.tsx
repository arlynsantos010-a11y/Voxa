                        ...
                        <div className="bg-white/[0.03] rounded-[2rem] p-6 border border-white/5 shadow-inner">
                            <Calendar
                                ...
                                classNames={{
                                    ...
                                    head_cell: "text-primary/40 font-black text-[10px] uppercase tracking-widest text-center w-full",
                                    row: "grid grid-cols-7 mt-2 w-full",
                                    cell: "relative p-0 text-center text-sm flex items-center justify-center w-full h-10",
